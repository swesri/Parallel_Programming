...
int main(int argc, char ** argv) {
   ...
   char * outfilename = "Mandelbrot1.pgm";  /* the sequential output filename */
   double time; 	/*timer*/
...
#pragma omp parallel for private(j,c_real,c_imag,z_real,z_imag,z_current_real,z_magnitude) shared(counter)
